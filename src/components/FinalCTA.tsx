...
export default function FinalCTA() {
  return (
    <section className="py-24 md:py-32 bg-[#0E1513] border-t border-outline-variant/20 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="max-w-[1440px] mx-auto px-5 md:px-12 lg:px-[120px] relative z-10 text-center">
        ...
        <a
          href="#schedule"
          className="inline-flex items-center gap-2.5 font-sans text-sm font-bold uppercase tracking-wider bg-primary text-on-primary hover:bg-primary-container px-10 py-5 rounded-lg transition-all duration-200 hover:scale-[1.03] shadow-lg shadow-primary/10"
        >
          Schedule Pickup
        </a>
      </div>
